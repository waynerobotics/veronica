...
bool operator==(const ::urg_node::Status_<ContainerAllocator1> & lhs, const ::urg_node::Status_<ContainerAllocator2> & rhs)
{
  return lhs.operating_mode == rhs.operating_mode &&
    lhs.area_number == rhs.area_number &&
    lhs.error_status == rhs.error_status &&
    lhs.error_code == rhs.error_code &&
    lhs.lockout_status == rhs.lockout_status &&
