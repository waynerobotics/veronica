...
with open('/home/warriorrobotics/veronica/src/igvc_navigation/mapping/lane_grid/Scripts/calibrate_camera.p', 'rb') as f:
...
def grid(img):
    ...
    rsz = cv2.resize(img, (int(width), int(height)),
...
def talker():
    ...
    # "/home/ringo/catkin_ws/src/lane_grid/Scripts/test_480.mp4")
