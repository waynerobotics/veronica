...
def hls_thresh2(img):
	...
	# L (OpenCV: [0 ... 255])
	# S (OpenCV: [0 ... 255])
	white_lower = np.array([np.round(  0 / 2), np.round(0.6 * 255), np.round(0.0* 255)])   ## For Nnamdi's Bedroom
	white_upper = np.array([np.round(360 / 2), np.round(1.00 * 255), np.round(0.4 * 255)])  ## For Nnamdi's Bedroom
